...
<body>
    ...
    <div class="main-content">
        <div class="container" data-aos="fade-down" data-aos-duration="1600">
            <div class="title_container">
                ...
                <span class="subtitle">Créez votre compte pour rejoindre notre communauté d'apprentissage.</span>
            </div>
                ...
                <div class="form-row">
                    <div class="input-group">
                        ...
                        <div class="relative">
                            ...
                            <!-- Eye Toggle Icon for password -->
                            <svg class="eye-toggle" id="eyeToggle1" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <div class="input-group">
                        ...
                        <div class="relative">
                            ...
                            <!-- Eye Toggle Icon for confirm password -->
                            <svg class="eye-toggle" id="eyeToggle2" xmlns="http://www.w3.org/2000/svg" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                viewBox="0 0 24 24">
                                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                <circle cx="12" cy="12" r="3"></circle>
                    ...
                    <div class="role-selection">
                        <div class="role-options">
                            <div class="role-option">
                                <input type="radio" name="role" value="etudiant" id="etudiant" required />
                                <label for="etudiant" class="role-card">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
                            ...
                            <div class="role-option">
                                ...
                                <label for="mentor" class="role-card">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                        viewBox="0 0 24 24">
                                        <path
    ...
    <script>
        ...
        // Password eye toggle functionality for both inputs

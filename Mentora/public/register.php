    ...
    if (empty($errors)) {
        try {
            ...
            if ($stmt->fetchColumn() > 0) {
                ...
                // Set success message for delayed redirect to login page
            ...
            <form action="register.php" method="post">
                <div class="form-row">
                    <div class="input-group">
                        ...
                        <div class="relative">
                            <input type="text" name="fullname" placeholder="Prénom Nom" value="<?= sanitize($fullname) ?>" />
                    ...
                    <div class="input-group">
                        ...
                        <div class="relative">
                            <input type="email" name="email" placeholder="nom@gmail.com" value="<?= sanitize($email) ?>" />
                ...
                <div class="form-row">
                    ...
                    <div class="input-group">
                        ...
                        <div class="relative">
                            <input type="password" name="confirm_password" id="confirmPasswordInput" placeholder="• • • • • • • •" />
                            <div><svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="M2 18v3c0 .6.4 1 1 1h4v-3h3v-3h2l1.4-1.4a6.5 6.5 0 1 0-4-4Z"></path><circle cx="16.5" cy="7.5" r=".5"></circle></svg></div>

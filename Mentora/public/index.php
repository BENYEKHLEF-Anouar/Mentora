...
// --- FETCH DATA FOR MENTORS WITH AVAILABILITY
...
// --- FETCH 3 MENTORS BASED ON AVAILABILITY/RATING ---
date_default_timezone_set('Europe/Paris');
$days = ['dimanche', 'lundi', 'mardi', 'mercredi', 'jeudi', 'vendredi', 'samedi'];
$currentDayName = $days[date('w')];
$currentTime = date('H:i:s');
                        ...
                        <?php foreach ($mentors as $mentor): ?>
                            <div class="profile-card" data-aos="fade-up">
                                <div class="card-image-container">
                                    <img src="<?= get_profile_image_path($mentor['photoUrl']) ?>" alt="<?= htmlspecialchars($mentor['prenomUtilisateur']) ?>">
                                </div>
                                <div class="card-body">
                ...
                <div class="profile-grid" data-aos="fade-up" data-aos-delay="200">
                     <?php foreach ($students as $student): ?>
                        <div class="profile-card">
                            <div class="card-image-container">
                                <img src="<?= get_profile_image_path($student['photoUrl']) ?>" alt="<?= htmlspecialchars($student['prenomUtilisateur']) ?>">
                            </div>
                            <div class="card-body">
                                ...
                                <!-- MODIFIED: Added student location -->

...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST["submit"])) {
    ...
    // --- Validation (Fully handled by PHP) ---
    if (empty($email)) {
    ...
    if (empty($errors)) {
        try {
            $stmt = $pdo->prepare("SELECT idUtilisateur, nomUtilisateur, prenomUtilisateur, emailUtilisateur, motDePasse, role FROM Utilisateur WHERE emailUtilisateur = :email");
            ...
            if ($user && password_verify($password, $user['motDePasse'])) {
                ...
                // We DON'T redirect with header() here anymore to allow the message to show.
        ...
        <div class="container" data-aos="fade-down" data-aos-duration="1600">
            ...
            <form action="login.php" method="post">
                <div class="input-group">
                    ...
                    <div class="relative">
                        <!-- 'required' attribute removed for manual PHP validation -->
                        <input type="email" name="email" value="<?= sanitize($email) ?>" placeholder="nom@gmail.com" />
                        <div>

...
// NEW: Fetch badges for the mentor
...
// NEW: Fetch latest reviews (avis) for the mentor
...
// NEW: Fetch mentor's uploaded resources
$stmtResources = $pdo->prepare("SELECT titreRessource, cheminRessource, typeFichier FROM Ressource WHERE idUtilisateur = :user_id ORDER BY titreRessource ASC LIMIT 10");
                ...
                <div class="content-card">
                    ...
                    <div class="resources-list">
                        <?php foreach($resources as $resource): ?>
                            <a href="../assets/resources/<?= htmlspecialchars($resource['cheminRessource']) ?>" class="resource-item-link" download>
                                <div class="resource-item">
                                    <div class="resource-icon">
                                        <i class="<?= get_file_icon_class($resource['typeFichier']) ?>"></i>
                                    </div>
                                    <div class="resource-info">
                                        <span class="resource-title"><?= htmlspecialchars($resource['titreRessource']) ?></span>
                                        <span class="resource-type"><?= htmlspecialchars(strtoupper($resource['typeFichier'])) ?></span>
                                    </div>
...
<script>
// The calendar script remains the same as it is already functional and well-designed.
// I am including it here to ensure the file is complete.
